...
**Bottom line:** The correlation design is sound for concurrent calls. Scale limits today are **storage** (JSONB span rewrite) and **sync ingest**, not call routing — see Section 12.
...
## 11. What we removed vs early designs
