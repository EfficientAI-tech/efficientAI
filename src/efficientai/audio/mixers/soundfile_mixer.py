...
from efficientai.frames.frames import MixerControlFrame, MixerEnableFrame, MixerUpdateSettingsFrame
...
try:
    ...
    logger.error(
        "In order to use the soundfile mixer, you need to `pip install efficientai-ai[soundfile]`."
    )
