...
from efficientai.utils.tracing.conversation_context_provider import ConversationContextProvider
from efficientai.utils.tracing.setup import is_tracing_available
from efficientai.utils.tracing.turn_context_provider import TurnContextProvider
...
class TurnTraceObserver(BaseObserver):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self._tracer = trace.get_tracer("efficientai.turn") if is_tracing_available() else None
