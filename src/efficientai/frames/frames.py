...
from efficientai.adapters.schemas.tools_schema import ToolsSchema
from efficientai.audio.dtmf.types import KeypadEntry as NewKeypadEntry
from efficientai.audio.interruptions.base_interruption_strategy import BaseInterruptionStrategy
from efficientai.audio.turn.smart_turn.base_smart_turn import SmartTurnParams
from efficientai.audio.vad.vad_analyzer import VADParams
from efficientai.metrics.metrics import MetricsData
from efficientai.transcriptions.language import Language
from efficientai.utils.time import nanoseconds_to_str
from efficientai.utils.utils import obj_count, obj_id

if TYPE_CHECKING:
    from efficientai.processors.aggregators.llm_context import LLMContext, NotGiven
...
class DeprecatedKeypadEntry:
    ...
    def _warn(cls):
        ...
        with warnings.catch_warnings():
            ...
            warnings.warn(
                "`efficientai.frames.frames.KeypadEntry` is deprecated and will be removed in a future version. "
                "Use `efficientai.audio.dtmf.types.KeypadEntry` instead.",
                DeprecationWarning,
                stacklevel=2,
            )
