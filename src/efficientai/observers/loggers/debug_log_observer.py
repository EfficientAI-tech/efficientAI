...
from efficientai.frames.frames import Frame
...
class DebugLogObserver(BaseObserver):
    ...
    Examples:
        ...
        Log specific frame types from any source/destination::
            ...
            from efficientai.frames.frames import LLMTextFrame, TranscriptionFrame
            observers=[
        ...
        Log frames with specific source/destination filters::
            ...
            from efficientai.frames.frames import InterruptionFrame, UserStartedSpeakingFrame, LLMTextFrame
            from efficientai.observers.loggers.debug_log_observer import DebugLogObserver, FrameEndpoint
            from efficientai.transports.base_output import BaseOutputTransport
            from efficientai.services.stt_service import STTService
