...
from efficientai.transports.tavus.transport import *

with warnings.catch_warnings():
    warnings.simplefilter("always")
    warnings.warn(
        "Module `efficientai.transports.services.tavus` is deprecated, "
        "use `efficientai.transports.tavus.transport` instead.",
        DeprecationWarning,
        stacklevel=2,
    )
