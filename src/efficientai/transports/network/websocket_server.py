...
from efficientai.transports.websocket.server import *

with warnings.catch_warnings():
    warnings.simplefilter("always")
    warnings.warn(
        "Module `efficientai.transports.network.websocket_server` is deprecated, "
        "use `efficientai.transports.websocket.server` instead.",
        DeprecationWarning,
        stacklevel=2,
    )
