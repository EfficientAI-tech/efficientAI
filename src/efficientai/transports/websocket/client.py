...
"""WebSocket client transport implementation for EfficientAI.
...
from efficientai.processors.frame_processor import FrameProcessorSetup
from efficientai.serializers.base_serializer import FrameSerializer
