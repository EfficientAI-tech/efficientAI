...
from efficientai.adapters.services.aws_nova_sonic_adapter import AWSNovaSonicLLMAdapter, Role
...
class AWSNovaSonicLLMService(LLMService):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        file_path = files("efficientai.services.aws.nova_sonic").joinpath("ready.wav")
