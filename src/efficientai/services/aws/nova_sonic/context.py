...
with warnings.catch_warnings():
    ...
    warnings.warn(
        "Types in efficientai.services.aws.nova_sonic.context (or "
        "efficientai.services.aws_nova_sonic.context) are deprecated. \n"
        "AWS Nova Sonic no longer uses types from this module under the hood. \n"
        "It now uses `LLMContext` and `LLMContextAggregatorPair`. \n"
        "Using the new patterns should allow you to not need types from this module.\n\n"
        "BEFORE:\n"
...
from efficientai.services.aws.nova_sonic.frames import AWSNovaSonicFunctionCallResultFrame
