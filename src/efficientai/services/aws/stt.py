...
from efficientai.services.aws.utils import build_event_message, decode_event, get_presigned_url
...
try:
    ...
    logger.error("In order to use AWS services, you need to `pip install efficientai-ai[aws]`.")
