...
.. deprecated:: 0.0.90
    ...
    Import it from efficientai.services.google.gemini_live.file_api instead.
"""
...
warnings.warn(
    ...
    "efficientai.services.gemini_multimodal_live.file_api is deprecated. "
    "Please import it from efficientai.services.google.gemini_live.file_api instead.",
    DeprecationWarning,
    stacklevel=2,
)
