...
.. deprecated:: 0.0.90
    ...
    efficientai.services.google.gemini_live.llm instead. Note that the new type names
    do not include 'Multimodal'.
"""

import warnings

from efficientai.services.google.gemini_live.llm import (
...
from efficientai.services.google.gemini_live.llm import GeminiMediaResolution as _GeminiMediaResolution
from efficientai.services.google.gemini_live.llm import GeminiVADParams as _GeminiVADParams
from efficientai.services.google.gemini_live.llm import InputParams as _InputParams

with warnings.catch_warnings():
    warnings.simplefilter("always")
    warnings.warn(
        "Types in efficientai.services.gemini_multimodal_live.gemini are deprecated. "
        "Please use the equivalent types from "
        "efficientai.services.google.gemini_live.llm instead. Note that the new type "
