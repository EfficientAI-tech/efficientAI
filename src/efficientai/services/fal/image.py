...
from efficientai.frames.frames import ErrorFrame, Frame, URLImageRawFrame
from efficientai.services.image_service import ImageGenService

try:
    import fal_client
except ModuleNotFoundError as e:
    logger.error(f"Exception: {e}")
    logger.error("In order to use Fal, you need to `pip install efficientai-ai[fal]`.")
