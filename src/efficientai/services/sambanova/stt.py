...
from efficientai.services.whisper.base_stt import BaseWhisperSTTService, Transcription
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        Args:
            ...
            **kwargs: Additional arguments passed to `efficientai.services.whisper.base_stt.BaseWhisperSTTService`.
        """
        super().__init__(
            model=model,
            api_key=api_key,
