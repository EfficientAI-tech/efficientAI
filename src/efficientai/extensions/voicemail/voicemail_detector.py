...
from efficientai.pipeline.parallel_pipeline import ParallelPipeline
...
from efficientai.sync.base_notifier import BaseNotifier
from efficientai.sync.event_notifier import EventNotifier
