...
from efficientai.runner.types import (
...
def get_transport_client_id(transport: BaseTransport, client: Any) -> str:
    ...
    try:
        from efficientai.transports.smallwebrtc.transport import SmallWebRTCTransport
    ...
    try:
        from efficientai.transports.daily.transport import DailyTransport
...
async def _create_telephony_transport(
    ...
    """
    from efficientai.transports.websocket.fastapi import FastAPIWebsocketTransport
