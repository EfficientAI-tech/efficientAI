...
def _setup_whatsapp_routes(app: FastAPI):
    ...
    try:
        ...
        from efficientai.transports.whatsapp.api import WhatsAppWebhookRequest
        from efficientai.transports.whatsapp.client import WhatsAppClient
    except ImportError as e:
...
def _setup_daily_routes(app: FastAPI):
    ...
    async def create_room_and_start_agent():
        ...
        from efficientai.runner.daily import configure
