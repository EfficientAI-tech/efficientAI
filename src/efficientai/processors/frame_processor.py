...
"""Frame processing pipeline infrastructure for EfficientAI.
...
from efficientai.metrics.metrics import LLMTokenUsage, MetricsData
from efficientai.observers.base_observer import BaseObserver, FrameProcessed, FramePushed
from efficientai.processors.metrics.frame_processor_metrics import FrameProcessorMetrics
from efficientai.utils.asyncio.task_manager import BaseTaskManager
from efficientai.utils.base_object import BaseObject
...
class FrameProcessor(BaseObject):
    ...
    Frame processors are the building blocks of EfficientAI pipelines, they can be
