# GET /api/v1/evaluator-results/metric-clusters

Get Evaluator Result Metric Clusters

- Operation ID: `getEvaluatorResultMetricClusters`
...
```bash
curl -X GET "http://localhost:8000/api/v1/evaluator-results/metric-clusters" \
