# POST /api/v1/evaluator-results/metric-clusters

Generate Evaluator Result Metric Clusters

- Operation ID: `generateEvaluatorResultMetricClusters`
...
```bash
curl -X POST "http://localhost:8000/api/v1/evaluator-results/metric-clusters" \
