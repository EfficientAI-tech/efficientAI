...
the prompt behavior, and the execution path used for every evaluation run. Nothing is scored
in isolation — scores always describe how a specific agent behaved.
