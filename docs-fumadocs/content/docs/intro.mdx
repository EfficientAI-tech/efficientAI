...
- **Usage tracking**: org-wide LLM, STT, and TTS consumption with cost estimates and drill-down by workspace and product area.
...
- [Usage](/docs/monitoring/usage/) — LLM/STT/TTS consumption, cost estimates, and drill-down by workspace and product area
- [Call Traces](/docs/monitoring/call-traces/) — Pipecat OTLP pipeline observability, latency percentiles (p50 / p90 / p95), and Calls hub routing
