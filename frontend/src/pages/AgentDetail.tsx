...
import { ArrowLeft, Trash2, X, AlertCircle, Edit2, Save, Eye, Code, Sparkles, Loader2, Bot } from 'lucide-react'
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="md:col-span-2">
                  ...
                  <dd className="mt-1 text-sm text-gray-900">
                    {agent.description ? (
                      <div className="prose prose-sm max-w-none prose-headings:text-gray-900 prose-p:text-gray-700 prose-code:text-gray-800 prose-code:bg-gray-100 prose-code:px-1 prose-code:py-0.5 prose-code:rounded prose-pre:bg-gray-900 prose-pre:text-gray-100 prose-ul:text-gray-700 prose-ol:text-gray-700">
                        ...
                        <dd className="mt-1 flex items-center gap-2">
                          {(() => {
                            ...
                            if (integration?.platform === 'retell') {
                              ...
                              return <><img src="/elevenlabs.jpg" alt="ElevenLabs" className="h-6 w-6 rounded-full object-contain" /><span className="text-base font-medium text-gray-900">ElevenLabs</span></>;
                            }
