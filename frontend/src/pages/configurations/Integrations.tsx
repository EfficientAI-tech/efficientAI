...
export default function Integrations() {
  ...
  const handleEdit = (integration: Integration) => {
    setIntegrationType('voice_platform'); setSelectedIntegration(integration)
    setSelectedPlatform(integration.platform as any); setName(integration.name || '')
    setApiKey(''); setPublicKey(integration.public_key || ''); setIsEditMode(true); setShowModal(true)
  }
  ...
  const platforms = [
    { id: IntegrationPlatform.RETELL, name: 'Retell AI', description: 'Connect your Retell AI voice agents', image: '/retellai.png' },
    { id: IntegrationPlatform.VAPI, name: 'Vapi', description: 'Connect your Vapi voice AI agents', image: '/vapiai.jpg' },
    { id: IntegrationPlatform.CARTESIA, name: 'Cartesia', description: 'Connect your Cartesia voice AI agents', image: '/cartesia.jpg' },
    { id: IntegrationPlatform.ELEVENLABS, name: 'ElevenLabs', description: 'Connect your ElevenLabs voice AI agents', image: '/elevenlabs.jpg' },
    { id: IntegrationPlatform.DEEPGRAM, name: 'Deepgram', description: 'Connect your Deepgram voice AI agents', image: '/deepgram.png' },
    { id: IntegrationPlatform.MURF, name: 'Murf', description: 'Connect your Murf TTS voice AI', image: '/murf.png' },
    { id: IntegrationPlatform.SARVAM, name: 'Sarvam', description: 'Connect your Sarvam STT & TTS voice AI', image: '/sarvam.png' },
    { id: IntegrationPlatform.VOICEMAKER, name: 'VoiceMaker', description: 'Connect your VoiceMaker TTS voice AI', image: '/voiceMaker.png' },
  ]
                      ...
                      {showPlatformDropdown && availablePlatforms.length > 0 && (
                        <div className="absolute z-10 w-full mt-1 bg-white border border-gray-300 rounded-lg shadow-lg max-h-60 overflow-auto">
                          {availablePlatforms.map((platform) => (
                            <button key={platform.id} type="button" onClick={() => { setSelectedPlatform(platform.id as any); setShowPlatformDropdown(false) }}
                              className="w-full px-3 py-2 text-left hover:bg-gray-50 flex items-center gap-2">
                              {platform.image ? <img src={platform.image} alt={platform.name} className="w-5 h-5 object-contain" /> : <Plug className="h-5 w-5 text-primary-600" />}
