                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6 relative">
                    ...
                    <div className="p-5 bg-gradient-to-br from-blue-50 to-sky-50 rounded-xl border-2 border-blue-200">
                        ...
                        <div className="space-y-4">
                            <div>
                                ...
                                <select value={providerA} onChange={(e) => { setProviderA(e.target.value); setSelectedVoicesA([]) }} className="w-full px-3 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 bg-white">
                    ...
                    <div className="p-5 bg-gradient-to-br from-purple-50 to-fuchsia-50 rounded-xl border-2 border-purple-200">
                        ...
                        <div className="space-y-4">
                            <div>
                                <label className="block text-sm font-medium text-gray-700 mb-1">TTS Provider</label>
                                <select value={providerB} onChange={(e) => { setProviderB(e.target.value); setSelectedVoicesB([]) }} className="w-full px-3 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 bg-white">
                                    <option value="">Select provider...</option>
